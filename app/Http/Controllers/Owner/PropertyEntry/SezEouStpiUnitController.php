...
class SezEouStpiUnitController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data = ['property_type' => 'sez_eou_stpi_unit', 'field_officer_id' => auth()->id(), 'status' => $status];
        ...
        if (isset($data['property_type']) && $data['property_type'] !== 'sez_eou_stpi_unit') {
        ...
        PropertyEntryLog::create([
            ...
            'note'              => $status === 'draft' ? 'Draft saved' : 'SEZ / EOU / STPI Unit submitted',
        ]);
