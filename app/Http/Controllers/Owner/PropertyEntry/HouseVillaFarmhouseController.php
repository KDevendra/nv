...
class HouseVillaFarmhouseController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (isset($data['property_type']) && $data['property_type'] !== 'house_villa_farmhouse') {
        ...
        PropertyEntryLog::create([
            ...
            'note'              => $status === 'draft' ? 'Draft saved' : 'House / Villa / Farmhouse submitted',
        ]);
