...
class FactoryManufacturingIndustrialController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('owner.properties.factory-manufacturing-industrial.create', compact('slots'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data = ['property_type' => 'factory_manufacturing_industrial', 'field_officer_id' => auth()->id(), 'status' => $status];
        ...
        if (isset($data['property_type']) && $data['property_type'] !== 'factory_manufacturing_industrial') {
            $customFields['property_sub_type'] = $data['property_type'];
        }
        $data['property_type'] = 'factory_manufacturing_industrial';
        ...
        PropertyEntryLog::create([
            ...
            'note'              => $status === 'draft' ? 'Draft saved' : 'Factory / Manufacturing / Industrial submitted',
        ]);
    ...
    public function edit(PropertyEntry $property): View
    {
        abort_if(auth()->user()->role !== 'owner', 403);
        $slots = self::PHOTO_SLOTS;
        return view('owner.properties.factory-manufacturing-industrial.create', compact('property', 'slots'));
    }
