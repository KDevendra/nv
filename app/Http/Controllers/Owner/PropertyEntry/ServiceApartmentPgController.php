...
class ServiceApartmentPgController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('owner.properties.service-apartment-pg.create', compact('slots'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data = ['property_type' => 'service_apartment_pg', 'field_officer_id' => auth()->id(), 'status' => $status];
        ...
        if (isset($data['property_type']) && $data['property_type'] !== 'service_apartment_pg') {
            $customFields['property_sub_type'] = $data['property_type'];
        }
        $data['property_type'] = 'service_apartment_pg';
        ...
        PropertyEntryLog::create([
            ...
            'note'              => $status === 'draft' ? 'Draft saved' : 'Service Apartment / Co-living / PG submitted',
        ]);
    ...
    public function edit(PropertyEntry $property): View
    {
        abort_if(auth()->user()->role !== 'owner', 403);
        $slots = self::PHOTO_SLOTS;
        return view('owner.properties.service-apartment-pg.create', compact('property', 'slots'));
    }
