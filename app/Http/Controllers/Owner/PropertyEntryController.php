...
class PropertyEntryController extends Controller
{
    ...
    private function validateEntry(Request $request, bool $isDraft): array
    {
        ...
        $typeRules = [
            ...
            'plot_area' => 'numeric|min:0|max:100000000',
            'built_up_area' => 'numeric|min:0|max:100000000',
            'carpet_area' => 'numeric|min:0|max:100000000',
            'available_area' => 'numeric|min:0|max:100000000',
            'clear_height_highest' => 'numeric|min:0|max:500',
            'clear_height_side' => 'numeric|min:0|max:500',
            'shed_width' => 'numeric|min:0|max:10000',
            'shed_length' => 'numeric|min:0|max:10000',
            'number_of_floors' => 'integer|min:0|max:300',
            'fsi_far' => 'string|max:50',
            'dock_door_count' => 'integer|min:0|max:1000',
            'dock_front' => 'integer|min:0|max:500',
            'dock_left' => 'integer|min:0|max:500',
            'dock_right' => 'integer|min:0|max:500',
            'dock_back' => 'integer|min:0|max:500',
            'dock_leveller_front' => 'integer|min:0|max:500',
            'dock_leveller_left' => 'integer|min:0|max:500',
            'dock_leveller_right' => 'integer|min:0|max:500',
            'dock_leveller_back' => 'integer|min:0|max:500',
            'fire_exit_front' => 'integer|min:0|max:500',
            'fire_exit_left' => 'integer|min:0|max:500',
            'fire_exit_right' => 'integer|min:0|max:500',
            'fire_exit_back' => 'integer|min:0|max:500',
            'canopy_width_front' => 'numeric|min:0|max:1000',
            'canopy_width_left' => 'numeric|min:0|max:1000',
            'canopy_width_right' => 'numeric|min:0|max:1000',
            'canopy_width_back' => 'numeric|min:0|max:1000',
            'has_dock_leveller' => 'boolean',
            'road_width_front' => 'numeric|min:0|max:1000',
            'road_width_left' => 'numeric|min:0|max:1000',
            'road_width_right' => 'numeric|min:0|max:1000',
            'road_width_back' => 'numeric|min:0|max:1000',
            'no_of_offices' => 'integer|min:0|max:500',
            'office_sizes' => 'nullable|string',
            'canteen' => 'boolean',
            'canteen_size' => 'string|max:255',
            'stp_plant' => 'boolean',
            'stp_capacity' => 'string|max:255',
            'no_of_urinals' => 'integer|min:0|max:1000',
            'no_of_closets' => 'integer|min:0|max:1000',
            ...
            'scrap_yard' => 'boolean',
            'no_of_companies_same_premise' => 'integer|min:0|max:500',
            'extension_possible' => 'boolean',
            'dock_type' => 'string|max:100',
            'dock_height' => 'numeric|min:0|max:100',
            'truck_movement' => 'string|max:100',
            'flooring_type' => 'string|max:100',
            'office_cabin_area' => 'numeric|min:0|max:1000000',
            'washrooms' => 'integer|min:0|max:1000',
            'ventilation_lighting' => 'string|max:50',
            'power_sanctioned_kva' => 'numeric|min:0|max:1000000',
            ...
            'expected_rent' => 'numeric|min:0|max:1000000000',
            'expected_sale_price' => 'numeric|min:0|max:10000000000',
            'security_deposit_months' => 'nullable|string|max:255',
            'lock_in_years' => 'numeric|min:0|max:99',
            'available_from' => 'date',
            'approach_road_width' => 'numeric|min:0|max:1000',
            'top_neighbouring_companies' => 'string',
            'flood_risk' => 'string|max:50',
            'nearest_hospital_km' => 'numeric|min:0|max:1000',
            'nearest_fire_station_km' => 'numeric|min:0|max:1000',
            'nearest_police_station_km' => 'numeric|min:0|max:1000',
            'remarks' => 'string',
            ...
            if ($isDraft) {
                ...
                if (!$isMandatory) {
                    ...
                    if ($field === 'canteen_size') {
                        ...
                        $presence = in_array($request->input('deal_type'), ['Lease', 'Rent', 'Both']) ? 'required' : 'nullable';
