                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="security_deposit_months" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="2 months" {{ old('security_deposit_months', $property->security_deposit_months ?? '') === '2 months' ? 'selected' : '' }}>2 months</option>
                                <option value="Fixed" {{ old('security_deposit_months', $property->security_deposit_months ?? '') === 'Fixed' ? 'selected' : '' }}>Fixed</option>
