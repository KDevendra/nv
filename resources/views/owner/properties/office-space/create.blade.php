                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="office_it_business_park_coworking_business_centre_ready_to_m"
                                    value="{{ old('office_it_business_park_coworking_business_centre_ready_to_m', $property->office_it_business_park_coworking_business_centre_ready_to_m ?? '') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="property_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Independent Office" {{ old('property_type', $property->property_type ?? '') === 'Independent Office' ? 'selected' : '' }}>Independent Office</option>
                                    <option value="Office in IT Park" {{ old('property_type', $property->property_type ?? '') === 'Office in IT Park' ? 'selected' : '' }}>Office in IT Park</option>
                                    <option value="Office in Business Park" {{ old('property_type', $property->property_type ?? '') === 'Office in Business Park' ? 'selected' : '' }}>Office in Business Park
                                    </option>
                                    <option value="Coworking" {{ old('property_type', $property->property_type ?? '') === 'Coworking' ? 'selected' : '' }}>Coworking</option>
                                    <option value="Business Centre" {{ old('property_type', $property->property_type ?? '') === 'Business Centre' ? 'selected' : '' }}>Business Centre</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="built_up_area_sq_ft"
                                    value="{{ old('built_up_area_sq_ft', $property->built_up_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="super_built_up_chargeable_area_sq_ft"
                                    value="{{ old('super_built_up_chargeable_area_sq_ft', $property->super_built_up_chargeable_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="total_floors_in_building"
                                    value="{{ old('total_floors_in_building', $property->total_floors_in_building ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="seating_workstation_capacity"
                                    value="{{ old('seating_workstation_capacity', $property->seating_workstation_capacity ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">No. of Cabins </label>
                                <input type="number" step="any" name="no_of_cabins"
                                    value="{{ old('no_of_cabins', $property->no_of_cabins ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="no_of_meeting_rooms"
                                    value="{{ old('no_of_meeting_rooms', $property->no_of_meeting_rooms ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="reception_area"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('reception_area', $property->reception_area ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('reception_area', $property->reception_area ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="pantry_cafeteria"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Private" {{ old('pantry_cafeteria', $property->pantry_cafeteria ?? '') === 'Private' ? 'selected' : '' }}>Private</option>
                                    <option value="Shared" {{ old('pantry_cafeteria', $property->pantry_cafeteria ?? '') === 'Shared' ? 'selected' : '' }}>Shared</option>
                                    <option value="None" {{ old('pantry_cafeteria', $property->pantry_cafeteria ?? '') === 'None' ? 'selected' : '' }}>None</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="washrooms"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Private" {{ old('washrooms', $property->washrooms ?? '') === 'Private' ? 'selected' : '' }}>Private</option>
                                    <option value="Shared" {{ old('washrooms', $property->washrooms ?? '') === 'Shared' ? 'selected' : '' }}>Shared</option>
                                    <option value="count" {{ old('washrooms', $property->washrooms ?? '') === 'count' ? 'selected' : '' }}>count</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="flooring_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Vitrified" {{ old('flooring_type', $property->flooring_type ?? '') === 'Vitrified' ? 'selected' : '' }}>Vitrified</option>
                                    <option value="Bare" {{ old('flooring_type', $property->flooring_type ?? '') === 'Bare' ? 'selected' : '' }}>Bare</option>
                                    <option value="Carpet" {{ old('flooring_type', $property->flooring_type ?? '') === 'Carpet' ? 'selected' : '' }}>Carpet</option>
                                    <option value="Raised access" {{ old('flooring_type', $property->flooring_type ?? '') === 'Raised access' ? 'selected' : '' }}>Raised access</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="car_parking_slots"
                                    value="{{ old('car_parking_slots', $property->car_parking_slots ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="lifts_passenger_service"
                                    value="{{ old('lifts_passenger_service', $property->lifts_passenger_service ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="sanctioned_power_load_kw_kva"
                                    value="{{ old('sanctioned_power_load_kw_kva', $property->sanctioned_power_load_kw_kva ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="air_conditioning"
                                    ...
                                    <option value="VRV-VRF" {{ old('air_conditioning', $property->air_conditioning ?? '') === 'VRV-VRF' ? 'selected' : '' }}>VRV-VRF</option>
                            ...
                            <div>
                                ...
                                <select name="fire_safety_system"
                                    ...
                                    <option value="Extinguishers" {{ old('fire_safety_system', $property->fire_safety_system ?? '') === 'Extinguishers' ? 'selected' : '' }}>Extinguishers</option>
                            ...
                            <div>
                                ...
                                <select name="water_supply"
                                    ...
                                    <option value="Both" {{ old('water_supply', $property->water_supply ?? '') === 'Both' ? 'selected' : '' }}>Both</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="building_security_access_control"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="24x7" {{ old('building_security_access_control', $property->building_security_access_control ?? '') === '24x7' ? 'selected' : '' }}>
                                        24x7</option>
                                    <option value="Card access" {{ old('building_security_access_control', $property->building_security_access_control ?? '') === 'Card access' ? 'selected' : '' }}>Card access</option>
                                    <option value="None" {{ old('building_security_access_control', $property->building_security_access_control ?? '') === 'None' ? 'selected' : '' }}>
                                        None</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="occupancy_single_multi_tenant"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('occupancy_single_multi_tenant', $property->occupancy_single_multi_tenant ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('occupancy_single_multi_tenant', $property->occupancy_single_multi_tenant ?? '') === 'No' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                            <div>
