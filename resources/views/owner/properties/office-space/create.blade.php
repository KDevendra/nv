...
<div class="max-w-5xl mx-auto space-y-6" x-data="stepWizard()">
    <div class="flex items-center justify-between mb-2">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Complete section-by-section submission form for Commercial Office Space</p>
        </div>
    ...
    <form method="POST" action="{{ isset($property) ? route('owner.properties.office-space.update', $property) : route('owner.properties.office-space.store') }}" enctype="multipart/form-data">
        @csrf
        @if(isset($property))
            @method('PUT')
        @endif

        <x-property-wizard-shell :steps="$steps" :title="'Commercial Office Space Submission Form'" :propertyType="'office_space'">
            ...
            <div class="wizard-step-content space-y-6" style="display:block">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Office · IT/Business Park · Coworking · Business Centre · 'ready to move' & 'furnished' are FIELDS, not types </label>
                            <input type="text" name="office_it_business_park_coworking_business_centre_ready_to_m" value="{{ old('office_it_business_park_coworking_business_centre_ready_to_m', $property->office_it_business_park_coworking_business_centre_ready_to_m ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="part_of_a_project_society" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="property_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="Office in Business Park" {{ old('property_type', $property->property_type ?? '') === 'Office in Business Park' ? 'selected' : '' }}>Office in Business Park</option>
                        ...
                        <div>
                            ...
                            <select required  name="grade" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Grade A" {{ old('grade', $property->grade ?? '') === 'Grade A' ? 'selected' : '' }}>Grade A</option>
                                <option value="B" {{ old('grade', $property->grade ?? '') === 'B' ? 'selected' : '' }}>B</option>
                                <option value="C" {{ old('grade', $property->grade ?? '') === 'C' ? 'selected' : '' }}>C</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Carpet Area (sq ft) <span class="text-red-500">*</span></label>
                            <input required  type="number" step="any" name="carpet_area_sq_ft" value="{{ old('carpet_area_sq_ft', $property->carpet_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Super Built-up / Chargeable Area (sq ft) </label>
                            <input type="number" step="any" name="super_built_up_chargeable_area_sq_ft" value="{{ old('super_built_up_chargeable_area_sq_ft', $property->super_built_up_chargeable_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Floor Number <span class="text-red-500">*</span></label>
                            <input required  type="text" name="floor_number" value="{{ old('floor_number', $property->floor_number ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Floors in Building </label>
                            <input type="number" step="any" name="total_floors_in_building" value="{{ old('total_floors_in_building', $property->total_floors_in_building ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Seating / Workstation Capacity </label>
                            <input type="number" step="any" name="seating_workstation_capacity" value="{{ old('seating_workstation_capacity', $property->seating_workstation_capacity ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">No. of Cabins </label>
                            <input type="number" step="any" name="no_of_cabins" value="{{ old('no_of_cabins', $property->no_of_cabins ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">No. of Meeting Rooms </label>
                            <input type="number" step="any" name="no_of_meeting_rooms" value="{{ old('no_of_meeting_rooms', $property->no_of_meeting_rooms ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Reception Area </label>
                            <select name="reception_area" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="pantry_cafeteria" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="washrooms" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="flooring_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="car_parking_slots" value="{{ old('car_parking_slots', $property->car_parking_slots ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    <div class="border-b pb-2 mb-4">
                        <h4 class="text-base font-bold text-zendo-navy">SECTION C2 — POSSESSION, FURNISHING & LISTING STATE  (drives SEO filter pages)</h4>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="construction_listing_status" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select required  name="furnishing_fit_out" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="located_inside" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Bank Loan / Lease Financing Available </label>
                            <select name="bank_loan_lease_financing_available" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Yes" {{ old('bank_loan_lease_financing_available', $property->bank_loan_lease_financing_available ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('bank_loan_lease_financing_available', $property->bank_loan_lease_financing_available ?? '') === 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Lifts (Passenger / Service) </label>
                            <input type="text" name="lifts_passenger_service" value="{{ old('lifts_passenger_service', $property->lifts_passenger_service ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Power Backup <span class="text-red-500">*</span></label>
                            <select required  name="power_backup" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Sanctioned Power Load (KW/KVA) </label>
                        ...
                        <div>
                            ...
                            <select name="water_supply" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Building Security / Access Control </label>
                            <select name="building_security_access_control" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="24x7" {{ old('building_security_access_control', $property->building_security_access_control ?? '') === '24x7' ? 'selected' : '' }}>24x7</option>
                                ...
                                <option value="None" {{ old('building_security_access_control', $property->building_security_access_control ?? '') === 'None' ? 'selected' : '' }}>None</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Occupancy — Single / Multi-tenant </label>
                            <select name="occupancy_single_multi_tenant" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Yes" {{ old('occupancy_single_multi_tenant', $property->occupancy_single_multi_tenant ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('occupancy_single_multi_tenant', $property->occupancy_single_multi_tenant ?? '') === 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="amenities_checklist[]" multiple class="select2-multiple w-full">
                                @php $sel = old('amenities_checklist', $property->amenities_checklist ?? []); @endphp
                                    <option value="Reception" {{ in_array('Reception', (array)$sel) ? 'selected' : '' }}>Reception</option>
                                    <option value="Conference" {{ in_array('Conference', (array)$sel) ? 'selected' : '' }}>Conference</option>
                                    <option value="Terrace" {{ in_array('Terrace', (array)$sel) ? 'selected' : '' }}>Terrace</option>
                                    <option value="Food court" {{ in_array('Food court', (array)$sel) ? 'selected' : '' }}>Food court</option>
                                    <option value="Parking" {{ in_array('Parking', (array)$sel) ? 'selected' : '' }}>Parking</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Interior office photos <span class="text-red-500">*</span></label>
                            <input required  type="text" name="interior_office_photos" value="{{ old('interior_office_photos', $property->interior_office_photos ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
