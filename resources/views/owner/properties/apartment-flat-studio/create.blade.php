...
<div class="max-w-5xl mx-auto space-y-6" x-data="apartmentWizard()">
    ...
    <div class="flex items-center justify-between mb-2">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Complete section-by-section specification form for Residential Apartment / Flat / Studio</p>
        </div>
    ...
    <form method="POST" action="{{ isset($property) ? route('owner.properties.apartment-flat-studio.update', $property) : route('owner.properties.apartment-flat-studio.store') }}" enctype="multipart/form-data">
        @csrf
        @if(isset($property))
            @method('PUT')
        @endif

        <x-property-wizard-shell :steps="$apartmentSteps" :title="'Apartment / Flat / Studio Submission Form'" :propertyType="'apartment_flat_studio'">
            ...
            <div class="wizard-step-content space-y-4" style="display:block">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input required  type="text" name="submitter_full_name" value="{{ old('submitter_full_name', $property->submitter_full_name ?? auth()->user()->name) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Submitter Phone <span class="text-red-500">*</span></label>
                        <input required  type="text" name="submitter_phone" value="{{ old('submitter_phone', $property->submitter_phone ?? auth()->user()->phone) }}" required placeholder="10-digit mobile" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Submitter Email <span class="text-red-500">*</span></label>
                        <input required  type="email" name="submitter_email" value="{{ old('submitter_email', $property->submitter_email ?? auth()->user()->email) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Submitter Role <span class="text-red-500">*</span></label>
                        <select name="submitter_role" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="company_entity_name" value="{{ old('company_entity_name', $property->company_entity_name ?? '') }}" placeholder="Company or entity name" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Owner Contact Name <span class="text-red-500">*</span></label>
                        <input required  type="text" name="owner_contact_name" value="{{ old('owner_contact_name', $property->owner_contact_name ?? auth()->user()->name) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Owner Contact Number <span class="text-red-500">*</span></label>
                        <input required  type="text" name="owner_contact_phone" value="{{ old('owner_contact_phone', $property->owner_contact_phone ?? auth()->user()->phone) }}" required placeholder="10-digit mobile" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Owner Email</label>
                        <input type="email" name="owner_email" value="{{ old('owner_email', $property->owner_email ?? '') }}" placeholder="Owner email address" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input required  type="text" name="postal_address_pin" value="{{ old('postal_address_pin', $property->postal_address_pin ?? '') }}" required maxlength="6" placeholder="6-digit PIN" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">City <span class="text-red-500">*</span></label>
                            <input required  type="text" name="city" value="{{ old('city', $property->city ?? '') }}" required placeholder="e.g. Mumbai, Gurgaon, Delhi" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Locality / Broad Area <span class="text-red-500">*</span></label>
                            <input required  type="text" name="locality_broad_area" value="{{ old('locality_broad_area', $property->locality_broad_area ?? '') }}" required placeholder="e.g. Bandra West, DLF Phase 5" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Sub-locality / Society Name</label>
                            <input type="text" name="sub_locality_society_name" value="{{ old('sub_locality_society_name', $property->sub_locality_society_name ?? '') }}" placeholder="Sub-locality or society" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Project Name</label>
                            <input type="text" name="project_name" value="{{ old('project_name', $property->project_name ?? '') }}" placeholder="Project name" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nearby_landmarks" value="{{ old('nearby_landmarks', $property->nearby_landmarks ?? '') }}" placeholder="Key landmarks nearby" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Distance from Key Locations</label>
                            <input type="text" name="distance_from_key_locations" value="{{ old('distance_from_key_locations', $property->distance_from_key_locations ?? '') }}" placeholder="Distance from Metro/School/Hospital" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="overlooking_view[]" multiple class="select2-multiple w-full">
                                ...
                                @foreach(['Main Road','Park-Garden','Pool','Club','Others'] as $vw)
                                    <option value="{{ $vw }}" {{ in_array($vw, $selectedOverlooking) ? 'selected' : '' }}>{{ $vw }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="part_of_a_project_society" required x-model="isPartOfProject" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="Yes" {{ old('part_of_a_project_society', $property->part_of_a_project_society ?? 'Yes') === 'Yes' ? 'selected' : '' }}>Yes</option>
                        ...
                        <div x-show="isPartOfProject === 'Yes'">
                            ...
                            <input type="number" name="total_towers_blocks" value="{{ old('total_towers_blocks', $property->total_towers_blocks ?? '') }}" min="0" placeholder="Total towers" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isPartOfProject === 'Yes'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Units in Project</label>
                            <input type="number" name="total_units_in_project" value="{{ old('total_units_in_project', $property->total_units_in_project ?? '') }}" min="0" placeholder="Total units" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isPartOfProject === 'Yes'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Approved Loan Banks</label>
                            <input type="text" name="approved_loan_banks" value="{{ old('approved_loan_banks', $property->approved_loan_banks ?? '') }}" placeholder="SBI, HDFC, ICICI..." class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isPartOfProject === 'Yes'">
                        ...
                        <div x-show="isPartOfProject === 'Yes'">
                            ...
                            <select name="project_amenities[]" multiple class="select2-multiple w-full">
                                ...
                                @foreach(['Clubhouse','Pool','Gym','Park','Sports','Power backup'] as $pam)
                                    <option value="{{ $pam }}" {{ in_array($pam, $selectedProjAmen) ? 'selected' : '' }}>{{ $pam }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="configuration" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Carpet Area (sq ft) <span class="text-red-500">*</span></label>
                            <input required  type="number" step="0.01" name="carpet_area" value="{{ old('carpet_area', $property->carpet_area ?? '') }}" required placeholder="e.g. 850" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Built-up Area (sq ft)</label>
                            <input type="number" step="0.01" name="built_up_area" value="{{ old('built_up_area', $property->built_up_area ?? '') }}" placeholder="e.g. 1100" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Super Built-up Area (sq ft)</label>
                            <input type="number" step="0.01" name="super_built_up_area" value="{{ old('super_built_up_area', $property->super_built_up_area ?? '') }}" placeholder="e.g. 1350" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Floor Number <span class="text-red-500">*</span></label>
                            <input required  type="number" name="floor_number" value="{{ old('floor_number', $property->floor_number ?? '') }}" required min="0" max="999" placeholder="0 = Ground" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Floors in Building <span class="text-red-500">*</span></label>
                            <input required  type="number" name="number_of_floors" value="{{ old('number_of_floors', $property->number_of_floors ?? '') }}" required min="0" max="999" placeholder="Total floors" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Units on This Floor</label>
                            <input type="number" name="units_on_this_floor" value="{{ old('units_on_this_floor', $property->units_on_this_floor ?? '') }}" min="0" max="999" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">No. of Bedrooms <span class="text-red-500">*</span></label>
                            <input required  type="number" name="no_of_bedrooms" value="{{ old('no_of_bedrooms', $property->no_of_bedrooms ?? '') }}" required min="0" max="999" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">No. of Bathrooms <span class="text-red-500">*</span></label>
                            <input required  type="number" name="no_of_bathrooms" value="{{ old('no_of_bathrooms', $property->no_of_bathrooms ?? '') }}" required min="0" max="999" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">No. of Balconies</label>
                            <input type="number" name="no_of_balconies" value="{{ old('no_of_balconies', $property->no_of_balconies ?? '') }}" min="0" max="999" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            ...
                            <select name="additional_rooms[]" multiple class="select2-multiple w-full">
                                ...
                                @foreach(['Pooja','Study','Servant','Store'] as $ar)
                                    <option value="{{ $ar }}" {{ in_array($ar, $selectedAddRooms) ? 'selected' : '' }}>{{ $ar }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Furnishing Status <span class="text-red-500">*</span></label>
                            <select name="furnishing_status" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="furnishing_detail[]" multiple class="select2-multiple w-full">
                                ...
                                @foreach(['wardrobes','modular kitchen','ACs','appliances'] as $fd)
                                    <option value="{{ $fd }}" {{ in_array($fd, $selectedFurnDetail) ? 'selected' : '' }}>{{ $fd }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Covered Parking Slots</label>
                            <input type="number" name="covered_parking_slots" value="{{ old('covered_parking_slots', $property->covered_parking_slots ?? '') }}" min="0" max="999" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Open Parking Slots</label>
                            <input type="number" name="open_parking_slots" value="{{ old('open_parking_slots', $property->open_parking_slots ?? '') }}" min="0" max="999" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="construction_listing_status" required x-model="constrStatus" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                        ...
                        <div x-show="constrStatus === 'Under Construction'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Possession By Date <span class="text-red-500">*</span></label>
                            <input required  type="date" name="possession_by" value="{{ old('possession_by', isset($property->possession_by) ? $property->possession_by->format('Y-m-d') : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="availability" required x-model="availability" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                        ...
                        <div x-show="availability === 'From date'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Available From Date <span class="text-red-500">*</span></label>
                            <input required  type="date" name="available_from" value="{{ old('available_from', isset($property->available_from) ? $property->available_from->format('Y-m-d') : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="title_status" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                        ...
                        <div>
                            ...
                            <select name="rera_registered" required x-model="reraReg" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                        ...
                        <div x-show="reraReg === 'Yes'">
                            ...
                            <input required  type="text" name="rera_registration_id" value="{{ old('rera_registration_id', $property->rera_registration_id ?? '') }}" placeholder="RERA reg number" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Occupancy Certificate (OC) <span class="text-red-500">*</span></label>
                            <select name="occupancy_certificate" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="Received" {{ old('occupancy_certificate', $property->occupancy_certificate ?? 'Received') === 'Received' ? 'selected' : '' }}>Received</option>
                                <option value="Applied" {{ old('occupancy_certificate', $property->occupancy_certificate ?? '') === 'Applied' ? 'selected' : '' }}>Applied</option>
                                <option value="Not Received" {{ old('occupancy_certificate', $property->occupancy_certificate ?? '') === 'Not Received' ? 'selected' : '' }}>Not Received</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Completion Certificate (CC)</label>
                            <select name="completion_certificate" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Received" {{ old('completion_certificate', $property->completion_certificate ?? '') === 'Received' ? 'selected' : '' }}>Received</option>
                                <option value="Applied" {{ old('completion_certificate', $property->completion_certificate ?? '') === 'Applied' ? 'selected' : '' }}>Applied</option>
                                <option value="Not Received" {{ old('completion_certificate', $property->completion_certificate ?? '') === 'Not Received' ? 'selected' : '' }}>Not Received</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Encumbrance / Loan on Property <span class="text-red-500">*</span></label>
                            <select name="encumbrance_loan_on_property" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="None" {{ old('encumbrance_loan_on_property', $property->encumbrance_loan_on_property ?? 'None') === 'None' ? 'selected' : '' }}>None</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Khata / Property Tax Status</label>
                            <select name="khata_property_tax_status" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Up to date" {{ old('khata_property_tax_status', $property->khata_property_tax_status ?? '') === 'Up to date' ? 'selected' : '' }}>Up to date</option>
                                <option value="Pending" {{ old('khata_property_tax_status', $property->khata_property_tax_status ?? '') === 'Pending' ? 'selected' : '' }}>Pending</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="electricity_status" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="gated_society" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="pet_friendly" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div class="md:col-span-3">
                            ...
                            <select name="amenities_checklist[]" multiple class="select2-multiple w-full">
                                ...
                                @foreach(['Gym','Pool','Clubhouse','Park','Play area','Lift','Garden'] as $am)
                                    <option value="{{ $am }}" {{ in_array($am, $selectedAmenities) ? 'selected' : '' }}>{{ $am }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div x-show="dealType === 'Rent' || dealType === 'Both'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Expected Rent (₹/month) <span class="text-red-500">*</span></label>
                            <input required  type="number" name="expected_rent" value="{{ old('expected_rent', $property->expected_rent ?? '') }}" placeholder="Monthly rent" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="dealType === 'Rent' || dealType === 'Both'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Security Deposit Months <span class="text-red-500">*</span></label>
                            <select required  name="security_deposit_months" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                @foreach(['1','2','3','6 months','Negotiable'] as $dep)
                                    <option value="{{ $dep }}" {{ old('security_deposit_months', $property->security_deposit_months ?? '') === $dep ? 'selected' : '' }}>{{ $dep }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div x-show="dealType === 'Sale' || dealType === 'Both'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Expected Sale Price (₹) <span class="text-red-500">*</span></label>
                            <input required  type="number" name="expected_sale_price" value="{{ old('expected_sale_price', $property->expected_sale_price ?? '') }}" placeholder="Total sale price" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Maintenance Charge (₹/month)</label>
                            <input type="number" name="maintenance_charge" value="{{ old('maintenance_charge', $property->maintenance_charge ?? '') }}" placeholder="Monthly maintenance" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Booking Amount (₹)</label>
                            <input type="number" name="booking_amount" value="{{ old('booking_amount', $property->booking_amount ?? '') }}" placeholder="Booking amount" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="preferred_tenant[]" multiple class="select2-multiple w-full">
                                ...
                                @foreach(['Family','Bachelor Male','Bachelor Female','Company','Any'] as $pt)
                                    <option value="{{ $pt }}" {{ in_array($pt, $selectedTenants) ? 'selected' : '' }}>{{ $pt }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Non-Veg Allowed</label>
                            <select name="non_veg_allowed" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="pets_allowed" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <input type="number" name="notice_period" value="{{ old('notice_period', $property->notice_period ?? '') }}" min="0" placeholder="Notice period" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Minimum Lease Term (months)</label>
                            <input type="number" name="minimum_lease_agreement_term" value="{{ old('minimum_lease_agreement_term', $property->minimum_lease_agreement_term ?? '') }}" min="0" placeholder="Minimum agreement term" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Electricity Charges</label>
                            <select name="electricity_charges" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Included" {{ old('electricity_charges', $property->electricity_charges ?? '') === 'Included' ? 'selected' : '' }}>Included</option>
                                <option value="Extra — as per meter" {{ old('electricity_charges', $property->electricity_charges ?? '') === 'Extra — as per meter' ? 'selected' : '' }}>Extra — as per meter</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Water Charges</label>
                            <select name="water_charges" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="maintenance_inclusion" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Included in rent" {{ old('maintenance_inclusion', $property->maintenance_inclusion ?? '') === 'Included in rent' ? 'selected' : '' }}>Included in rent</option>
                                <option value="Extra fixed" {{ old('maintenance_inclusion', $property->maintenance_inclusion ?? '') === 'Extra fixed' ? 'selected' : '' }}>Extra fixed</option>
                                <option value="Extra per sq ft" {{ old('maintenance_inclusion', $property->maintenance_inclusion ?? '') === 'Extra per sq ft' ? 'selected' : '' }}>Extra per sq ft</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="currently_rented_tenanted" required x-model="isTenanted" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="No" {{ old('currently_rented_tenanted', $property->currently_rented_tenanted ?? 'No') === 'No' ? 'selected' : '' }}>No</option>
                        ...
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Current Monthly Rent Received (₹) <span class="text-red-500">*</span></label>
                            <input required  type="number" name="current_monthly_rent_received" value="{{ old('current_monthly_rent_received', $property->current_monthly_rent_received ?? '') }}" placeholder="Monthly rent" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tenant Name / Profile</label>
                            <input type="text" name="tenant_name_profile" value="{{ old('tenant_name_profile', $property->tenant_name_profile ?? '') }}" placeholder="Tenant name / profile" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tenant Type</label>
                            <select name="tenant_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Lease Start Date <span class="text-red-500">*</span></label>
                            <input required  type="date" name="lease_start_date" value="{{ old('lease_start_date', isset($property->lease_start_date) ? $property->lease_start_date->format('Y-m-d') : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Lease Tenure (years) <span class="text-red-500">*</span></label>
                            <input required  type="number" name="lease_tenure" value="{{ old('lease_tenure', $property->lease_tenure ?? '') }}" placeholder="e.g. 3" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Lock-in Remaining (months) <span class="text-red-500">*</span></label>
                            <input required  type="number" name="lock_in_remaining" value="{{ old('lock_in_remaining', $property->lock_in_remaining ?? '') }}" placeholder="e.g. 12" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Annual Escalation in Lease (%)</label>
                            <input type="number" step="0.01" name="annual_escalation_in_lease" value="{{ old('annual_escalation_in_lease', $property->annual_escalation_in_lease ?? '') }}" placeholder="e.g. 5.0" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Security Deposit Held (₹)</label>
                            <input type="text" name="security_deposit_held" value="{{ old('security_deposit_held', $property->security_deposit_held ?? '') }}" placeholder="Deposit amount" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Deposit Adjustment on Sale</label>
                            <select name="deposit_adjustment_on_sale" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                @foreach(['Transferred to buyer','Refunded','Negotiable'] as $depAdj)
                                    <option value="{{ $depAdj }}" {{ old('deposit_adjustment_on_sale', $property->deposit_adjustment_on_sale ?? '') === $depAdj ? 'selected' : '' }}>{{ $depAdj }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div x-show="isTenanted === 'Yes' || isTenanted === 'Partially'">
                            ...
                            <select name="cam_outgoings_borne_by" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                @foreach(['Tenant','Owner','Shared'] as $cam)
                                    <option value="{{ $cam }}" {{ old('cam_outgoings_borne_by', $property->cam_outgoings_borne_by ?? '') === $cam ? 'selected' : '' }}>{{ $cam }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                <div>
                    <div class="border-b pb-2 mb-4">
                        ...
                        <p class="text-xs text-gray-500">Interior rooms, exterior photos, floor plans & 360 video walkthrough links</p>
                    </div>
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            @foreach($slots as $idx => $label)
                                <div class="border border-gray-200 rounded-lg p-3 bg-gray-50 text-center">
                                    ...
                                    <input type="file" name="photo_{{ $idx }}" accept="image/*,.pdf" class="text-xs w-full text-gray-500">
                                </div>
                            @endforeach
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Virtual Tour / 360 Link</label>
                                <input type="url" name="virtual_tour_360_link" value="{{ old('virtual_tour_360_link', $property->virtual_tour_360_link ?? '') }}" placeholder="https://my.matterport.com/..." class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input required  type="date" name="inspection_submission_date" value="{{ old('inspection_submission_date', isset($property->inspection_submission_date) ? $property->inspection_submission_date->format('Y-m-d') : date('Y-m-d')) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Public Property Description</label>
                            <textarea name="property_description" rows="3" placeholder="Public facing description of the property..." class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">{{ old('property_description', $property->property_description ?? '') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Submitter Remarks <span class="text-red-500">*</span></label>
                            <textarea name="remarks" required rows="3" placeholder="General remarks, special highlights or notes..." class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">{{ old('remarks', $property->remarks ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
