...
@section('content')
    ...
    <div class="max-w-5xl mx-auto space-y-6" x-data="stepWizard()">
        ...
        <form method="POST"
            action="{{ isset($property) ? route('owner.properties.builder-floor.update', $property) : route('owner.properties.builder-floor.store') }}"
            ...
            <x-property-wizard-shell :steps="$steps" :title="'Builder Floor Submission Form'"
                ...
                <div class="wizard-step-content space-y-6" style="display:none">
                    ...
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Which Floor <span
                                        class="text-red-500">*</span></label>
                                <select required name="which_floor"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="plot_size_sq_yd"
                                    value="{{ old('plot_size_sq_yd', $property->plot_size_sq_yd ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Built-up Area (sq ft) <span
                                        class="text-red-500">*</span></label>
                                <input required type="number" step="any" name="built_up_area_sq_ft"
                            ...
                            <div>
                                ...
                                <input required type="number" step="any" name="no_of_bedrooms"
                                    value="{{ old('no_of_bedrooms', $property->no_of_bedrooms ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="number" step="any" name="no_of_bathrooms"
                                    value="{{ old('no_of_bathrooms', $property->no_of_bathrooms ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">No. of Balconies </label>
                                <input type="number" step="any" name="no_of_balconies"
                                    value="{{ old('no_of_balconies', $property->no_of_balconies ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="stilt_covered_parking"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                            ...
                            <div>
                                ...
                                <select name="roof_terrace_rights"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes (if top)" {{ old('roof_terrace_rights', $property->roof_terrace_rights ?? '') === 'Yes (if top)' ? 'selected' : '' }}>Yes (if
                                        top)</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="age_of_property"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="<1" {{ old('age_of_property', $property->age_of_property ?? '') === '<1' ? 'selected' : '' }}>
                                        <1< /option>
                    ...
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="gated_colony_security"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="listing_purpose_transaction_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Rent" {{ old('listing_purpose_transaction_type', $property->listing_purpose_transaction_type ?? '') === 'Rent' ? 'selected' : '' }}>
                                        Rent</option>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="expected_rent_month"
                                    value="{{ old('expected_rent_month', $property->expected_rent_month ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="maintenance_charge_month"
                                    value="{{ old('maintenance_charge_month', $property->maintenance_charge_month ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="non_veg_pets_allowed"
                                    ...
                                    <option value="Non-veg only" {{ old('non_veg_pets_allowed', $property->non_veg_pets_allowed ?? '') === 'Non-veg only' ? 'selected' : '' }}>Non-veg
                                        only</option>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="notice_period_months"
                                    value="{{ old('notice_period_months', $property->notice_period_months ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="minimum_lease_agreement_term_months"
                                    value="{{ old('minimum_lease_agreement_term_months', $property->minimum_lease_agreement_term_months ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="utilities_who_bears"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Included in rent" {{ old('utilities_who_bears', $property->utilities_who_bears ?? '') === 'Included in rent' ? 'selected' : '' }}>
                                        Included in rent</option>
                                    <option value="Extra as per usage" {{ old('utilities_who_bears', $property->utilities_who_bears ?? '') === 'Extra as per usage' ? 'selected' : '' }}>
