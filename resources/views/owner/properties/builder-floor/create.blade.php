                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="property_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Builder Floor" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Builder Floor' ? 'selected' : '' }}>Builder Floor</option>
                                    <option value="Independent Floor" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Independent Floor' ? 'selected' : '' }}>Independent Floor</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select required name="configuration_bhk"
                                    ...
                                    <option value="4+ BHK" {{ old('configuration_bhk', $property?->fieldValue('configuration_bhk') ?? '') === '4+ BHK' ? 'selected' : '' }}>4+ BHK</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select required name="which_floor"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Ground" {{ old('which_floor', $property?->fieldValue('which_floor') ?? '') === 'Ground' ? 'selected' : '' }}>Ground</option>
                                    <option value="1st" {{ old('which_floor', $property?->fieldValue('which_floor') ?? '') === '1st' ? 'selected' : '' }}>1st</option>
                                    <option value="2nd" {{ old('which_floor', $property?->fieldValue('which_floor') ?? '') === '2nd' ? 'selected' : '' }}>2nd</option>
                                    <option value="3rd" {{ old('which_floor', $property?->fieldValue('which_floor') ?? '') === '3rd' ? 'selected' : '' }}>3rd</option>
                                    <option value="Top" {{ old('which_floor', $property?->fieldValue('which_floor') ?? '') === 'Top' ? 'selected' : '' }}>Top</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="plot_size_sq_yd"
                                    value="{{ old('plot_size_sq_yd', $property?->fieldValue('plot_size_sq_yd') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="no_of_balconies"
                                    value="{{ old('no_of_balconies', $property?->fieldValue('no_of_balconies') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="stilt_covered_parking"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('stilt_covered_parking', $property?->fieldValue('stilt_covered_parking') ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('stilt_covered_parking', $property?->fieldValue('stilt_covered_parking') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="roof_terrace_rights"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes (if top)" {{ old('roof_terrace_rights', $property?->fieldValue('roof_terrace_rights') ?? '') === 'Yes (if top)' ? 'selected' : '' }}>Yes (if
                                        top)</option>
                                    <option value="No" {{ old('roof_terrace_rights', $property?->fieldValue('roof_terrace_rights') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                    <option value="Shared" {{ old('roof_terrace_rights', $property?->fieldValue('roof_terrace_rights') ?? '') === 'Shared' ? 'selected' : '' }}>Shared</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="lift_available"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('lift_available', $property?->fieldValue('lift_available') ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('lift_available', $property?->fieldValue('lift_available') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="gated_colony_security"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('gated_colony_security', $property?->fieldValue('gated_colony_security') ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('gated_colony_security', $property?->fieldValue('gated_colony_security') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
