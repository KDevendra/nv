...
@section('content')
    @php
        ...
        // config('property_entry_sections.multi_tenant_building'). Letters skip
        // (no F, G2 or I here) because the spec sheet itself skips them; each
        // tab must correspond to exactly one wizard-step-content panel below,
        ...
        $steps = [
            ...
            ['key' => 'C', 'title' => 'Building Specifications'],
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="property_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Standalone Building" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Standalone Building' ? 'selected' : '' }}>Standalone Building</option>
                                    <option value="IT Park block" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'IT Park block' ? 'selected' : '' }}>IT Park block</option>
                                    <option value="Mixed-use" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Mixed-use' ? 'selected' : '' }}>Mixed-use</option>
                                    <option value="Commercial Complex" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Commercial Complex' ? 'selected' : '' }}>Commercial Complex</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input required type="number" step="any" name="total_leasable_area_sq_ft"
                                    value="{{ old('total_leasable_area_sq_ft', $property?->fieldValue('total_leasable_area_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="total_built_up_area_sq_ft"
                                    value="{{ old('total_built_up_area_sq_ft', $property?->fieldValue('total_built_up_area_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="plot_area_sq_ft"
                                    value="{{ old('plot_area_sq_ft', $property?->fieldValue('plot_area_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="number" step="any" name="number_of_floors"
                                    value="{{ old('number_of_floors', $property?->fieldValue('number_of_floors') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="typical_floor_plate_sq_ft"
                                    value="{{ old('typical_floor_plate_sq_ft', $property?->fieldValue('typical_floor_plate_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="currently_occupied"
                                    value="{{ old('currently_occupied', $property?->fieldValue('currently_occupied') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="text" name="existing_tenants_anchor"
                                    value="{{ old('existing_tenants_anchor', $property?->fieldValue('existing_tenants_anchor') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="total_car_parking"
                                    value="{{ old('total_car_parking', $property?->fieldValue('total_car_parking') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="lifts_passenger_service_count"
                                    value="{{ old('lifts_passenger_service_count', $property?->fieldValue('lifts_passenger_service_count') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="sanctioned_power_load_kva"
                                    value="{{ old('sanctioned_power_load_kva', $property?->fieldValue('sanctioned_power_load_kva') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">DG Set Capacity </label>
                                <input type="text" name="dg_set_capacity"
                                    value="{{ old('dg_set_capacity', $property?->fieldValue('dg_set_capacity') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="water_supply_tank_capacity"
                                    value="{{ old('water_supply_tank_capacity', $property?->fieldValue('water_supply_tank_capacity') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="stp_plant"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('stp_plant', $property?->fieldValue('stp_plant') ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('stp_plant', $property?->fieldValue('stp_plant') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="building_management_system"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('building_management_system', $property?->fieldValue('building_management_system') ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('building_management_system', $property?->fieldValue('building_management_system') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="security_access_control"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="24x7" {{ old('security_access_control', $property?->fieldValue('security_access_control') ?? '') === '24x7' ? 'selected' : '' }}>24x7
                                    </option>
                                    <option value="Card" {{ old('security_access_control', $property?->fieldValue('security_access_control') ?? '') === 'Card' ? 'selected' : '' }}>Card
                                    </option>
                                    <option value="None" {{ old('security_access_control', $property?->fieldValue('security_access_control') ?? '') === 'None' ? 'selected' : '' }}>None
                                    </option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="green_igbc_leed_certified"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('green_igbc_leed_certified', $property?->fieldValue('green_igbc_leed_certified') ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('green_igbc_leed_certified', $property?->fieldValue('green_igbc_leed_certified') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                    </div>
