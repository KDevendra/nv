...
@section('title', (isset($property) ? 'Edit' : 'List New') . ' Multi-Tenant Commercial Building - Owner Portal')
...
@section('content')
    ...
    <div class="max-w-5xl mx-auto space-y-6" x-data="stepWizard()">
        <div class="flex items-center justify-between mb-2">
            <div>
                <h2 class="text-2xl font-heading text-zendo-navy font-semibold">
                    {{ isset($property) ? 'Edit Listing: ' . $property->code : 'List Multi-Tenant Commercial Building' }}
                </h2>
                <p class="text-gray-500 text-sm mt-1">Complete section-by-section submission form for Multi-Tenant
        ...
        <form method="POST"
            action="{{ isset($property) ? route('owner.properties.multi-tenant-building.update', $property) : route('owner.properties.multi-tenant-building.store') }}"
            ...
            <x-property-wizard-shell :steps="$steps" :title="'Multi-Tenant Commercial Building Submission Form'"
                :propertyType="'multi_tenant_building'">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input required type="text" name="submitter_full_name"
                                    value="{{ old('submitter_full_name', $property->submitter_full_name ?? '') }}"
                            ...
                            <div>
                                ...
                                <input required type="text" name="submitter_phone"
                                    value="{{ old('submitter_phone', $property->submitter_phone ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="text" name="submitter_email"
                                    value="{{ old('submitter_email', $property->submitter_email ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input required type="text" name="owner_full_name"
                                    value="{{ old('owner_full_name', $property->owner_full_name ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="text" name="owner_contact_number"
                                    value="{{ old('owner_contact_number', $property->owner_contact_number ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input required type="number" step="any" name="pin_code"
                                    value="{{ old('pin_code', $property->pin_code ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input required type="text" name="locality_broad_area"
                                    value="{{ old('locality_broad_area', $property->locality_broad_area ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input required type="text" name="full_address_house_plot_no_street"
                                    value="{{ old('full_address_house_plot_no_street', $property->full_address_house_plot_no_street ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="nearby_landmarks_key_distances"
                                    value="{{ old('nearby_landmarks_key_distances', $property->nearby_landmarks_key_distances ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="part_of_a_project_society" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('part_of_a_project_society', $property->part_of_a_project_society ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="total_towers_blocks"
                                    value="{{ old('total_towers_blocks', $property->total_towers_blocks ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                ...
                <div class="wizard-step-content space-y-6" style="display:none">
                    ...
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        <div class="border-b pb-2 mb-4">
                            <h4 class="text-base font-bold text-zendo-navy">SECTION C — BUILDING SPECIFICATIONS</h4>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="property_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Standalone Building" {{ old('property_type', $property->property_type ?? '') === 'Standalone Building' ? 'selected' : '' }}>Standalone Building</option>
                                    <option value="IT Park block" {{ old('property_type', $property->property_type ?? '') === 'IT Park block' ? 'selected' : '' }}>IT Park block</option>
                                    <option value="Mixed-use" {{ old('property_type', $property->property_type ?? '') === 'Mixed-use' ? 'selected' : '' }}>Mixed-use</option>
                                    <option value="Commercial Complex" {{ old('property_type', $property->property_type ?? '') === 'Commercial Complex' ? 'selected' : '' }}>Commercial Complex</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select required name="grade"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Grade A" {{ old('grade', $property->grade ?? '') === 'Grade A' ? 'selected' : '' }}>Grade A</option>
                                    <option value="B" {{ old('grade', $property->grade ?? '') === 'B' ? 'selected' : '' }}>B
                                    </option>
                                    <option value="C" {{ old('grade', $property->grade ?? '') === 'C' ? 'selected' : '' }}>C
                                    </option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Total Leasable Area (sq ft)
                                    <span class="text-red-500">*</span></label>
                                <input required type="number" step="any" name="total_leasable_area_sq_ft"
                                    value="{{ old('total_leasable_area_sq_ft', $property->total_leasable_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Total Built-up Area (sq ft)
                                </label>
                                <input type="number" step="any" name="total_built_up_area_sq_ft"
                                    value="{{ old('total_built_up_area_sq_ft', $property->total_built_up_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Plot Area (sq ft) </label>
                                <input type="number" step="any" name="plot_area_sq_ft"
                                    value="{{ old('plot_area_sq_ft', $property->plot_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Number of Floors <span
                                        class="text-red-500">*</span></label>
                                <input required type="number" step="any" name="number_of_floors"
                                    value="{{ old('number_of_floors', $property->number_of_floors ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Typical Floor Plate (sq ft)
                                </label>
                                <input type="number" step="any" name="typical_floor_plate_sq_ft"
                                    value="{{ old('typical_floor_plate_sq_ft', $property->typical_floor_plate_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Currently Occupied (%) </label>
                                <input type="number" step="any" name="currently_occupied"
                                    value="{{ old('currently_occupied', $property->currently_occupied ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Existing Tenants / Anchor
                                </label>
                                <input type="text" name="existing_tenants_anchor"
                                    value="{{ old('existing_tenants_anchor', $property->existing_tenants_anchor ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Total Car Parking </label>
                                <input type="number" step="any" name="total_car_parking"
                                    value="{{ old('total_car_parking', $property->total_car_parking ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="possession_by_if_under_constr"
                                    value="{{ old('possession_by_if_under_constr', isset($property->possession_by_if_under_constr) ? $property->possession_by_if_under_constr->format('Y-m-d') : '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="located_inside"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="SEZ" {{ old('located_inside', $property->located_inside ?? '') === 'SEZ' ? 'selected' : '' }}>SEZ</option>
                                    <option value="IT Park" {{ old('located_inside', $property->located_inside ?? '') === 'IT Park' ? 'selected' : '' }}>IT Park</option>
                                    <option value="Business Park" {{ old('located_inside', $property->located_inside ?? '') === 'Business Park' ? 'selected' : '' }}>Business Park</option>
                                    <option value="Industrial Estate" {{ old('located_inside', $property->located_inside ?? '') === 'Industrial Estate' ? 'selected' : '' }}>Industrial Estate</option>
                                    <option value="Standalone" {{ old('located_inside', $property->located_inside ?? '') === 'Standalone' ? 'selected' : '' }}>Standalone</option>
                                    <option value="Mall" {{ old('located_inside', $property->located_inside ?? '') === 'Mall' ? 'selected' : '' }}>Mall</option>
                                    <option value="High-street" {{ old('located_inside', $property->located_inside ?? '') === 'High-street' ? 'selected' : '' }}>High-street</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="age_of_building"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="<1" {{ old('age_of_building', $property->age_of_building ?? '') === '<1' ? 'selected' : '' }}>
                                        <1< /option>
                            ...
                            <div>
                                ...
                                <input type="date" name="available_from_date"
                                    value="{{ old('available_from_date', isset($property->available_from_date) ? $property->available_from_date->format('Y-m-d') : '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="bank_loan_lease_financing_available"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('bank_loan_lease_financing_available', $property->bank_loan_lease_financing_available ?? '') === 'Yes' ? 'selected' : '' }}>
                                        Yes</option>
                                    <option value="No" {{ old('bank_loan_lease_financing_available', $property->bank_loan_lease_financing_available ?? '') === 'No' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="ownership_title_type"
                                    ...
                                    <option value="Leasehold-Govt" {{ old('ownership_title_type', $property->ownership_title_type ?? '') === 'Leasehold-Govt' ? 'selected' : '' }}>
                                        Leasehold-Govt</option>
                                    <option value="Leasehold-Private" {{ old('ownership_title_type', $property->ownership_title_type ?? '') === 'Leasehold-Private' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select required name="occupancy_certificate_oc"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Received" {{ old('occupancy_certificate_oc', $property->occupancy_certificate_oc ?? '') === 'Received' ? 'selected' : '' }}>
                                        Received</option>
                                    <option value="Applied" {{ old('occupancy_certificate_oc', $property->occupancy_certificate_oc ?? '') === 'Applied' ? 'selected' : '' }}>Applied
                                    </option>
                                    <option value="Not Received" {{ old('occupancy_certificate_oc', $property->occupancy_certificate_oc ?? '') === 'Not Received' ? 'selected' : '' }}>Not
                                        Received</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select required name="clu_land_use_approval"
                                    ...
                                    <option value="Mixed-Use" {{ old('clu_land_use_approval', $property->clu_land_use_approval ?? '') === 'Mixed-Use' ? 'selected' : '' }}>Mixed-Use
                                    </option>
                                    <option value="Conversion Applied" {{ old('clu_land_use_approval', $property->clu_land_use_approval ?? '') === 'Conversion Applied' ? 'selected' : '' }}>
                                        Conversion Applied</option>
                                    <option value="Not Converted" {{ old('clu_land_use_approval', $property->clu_land_use_approval ?? '') === 'Not Converted' ? 'selected' : '' }}>Not
                                        Converted</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select required name="fire_noc_status"
                                    ...
                                    <option value="Applied — In Process" {{ old('fire_noc_status', $property->fire_noc_status ?? '') === 'Applied — In Process' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select name="pollution_environment_noc"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Obtained" {{ old('pollution_environment_noc', $property->pollution_environment_noc ?? '') === 'Obtained' ? 'selected' : '' }}>
                                        Obtained</option>
                                    <option value="Applied" {{ old('pollution_environment_noc', $property->pollution_environment_noc ?? '') === 'Applied' ? 'selected' : '' }}>Applied
                                    </option>
                                    <option value="Not Applicable" {{ old('pollution_environment_noc', $property->pollution_environment_noc ?? '') === 'Not Applicable' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select required name="encumbrance_loan_on_property"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="None" {{ old('encumbrance_loan_on_property', $property->encumbrance_loan_on_property ?? '') === 'None' ? 'selected' : '' }}>None
                                    </option>
                                    <option value="Loan" {{ old('encumbrance_loan_on_property', $property->encumbrance_loan_on_property ?? '') === 'Loan' ? 'selected' : '' }}>Loan
                                    </option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Lifts (Passenger / Service
                                    count) </label>
                                <input type="text" name="lifts_passenger_service_count"
                                    value="{{ old('lifts_passenger_service_count', $property->lifts_passenger_service_count ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Sanctioned Power Load (KVA)
                                </label>
                                <input type="text" name="sanctioned_power_load_kva"
                                    value="{{ old('sanctioned_power_load_kva', $property->sanctioned_power_load_kva ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">DG Set Capacity </label>
                                <input type="text" name="dg_set_capacity"
                                    value="{{ old('dg_set_capacity', $property->dg_set_capacity ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="fire_safety_system"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Sprinkler+Hydrant" {{ old('fire_safety_system', $property->fire_safety_system ?? '') === 'Sprinkler+Hydrant' ? 'selected' : '' }}>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Water Supply / Tank Capacity
                                </label>
                                <input type="text" name="water_supply_tank_capacity"
                                    value="{{ old('water_supply_tank_capacity', $property->water_supply_tank_capacity ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">STP Plant </label>
                                <select name="stp_plant"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('stp_plant', $property->stp_plant ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('stp_plant', $property->stp_plant ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Building Management System
                                </label>
                                <select name="building_management_system"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('building_management_system', $property->building_management_system ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('building_management_system', $property->building_management_system ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Security / Access Control
                                </label>
                                <select name="security_access_control"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="24x7" {{ old('security_access_control', $property->security_access_control ?? '') === '24x7' ? 'selected' : '' }}>24x7
                                    </option>
                                    <option value="Card" {{ old('security_access_control', $property->security_access_control ?? '') === 'Card' ? 'selected' : '' }}>Card
                                    </option>
                                    <option value="None" {{ old('security_access_control', $property->security_access_control ?? '') === 'None' ? 'selected' : '' }}>None
                                    </option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Green / IGBC / LEED Certified
                                </label>
                                <select name="green_igbc_leed_certified"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('green_igbc_leed_certified', $property->green_igbc_leed_certified ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('green_igbc_leed_certified', $property->green_igbc_leed_certified ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="listing_purpose_transaction_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Lease" {{ old('listing_purpose_transaction_type', $property->listing_purpose_transaction_type ?? '') === 'Lease' ? 'selected' : '' }}>
                                        Lease</option>
                                    <option value="Sale" {{ old('listing_purpose_transaction_type', $property->listing_purpose_transaction_type ?? '') === 'Sale' ? 'selected' : '' }}>
                                        Sale</option>
                                    <option value="Both" {{ old('listing_purpose_transaction_type', $property->listing_purpose_transaction_type ?? '') === 'Both' ? 'selected' : '' }}>
                                        Both</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="expected_rent_sq_ft_month"
                                    value="{{ old('expected_rent_sq_ft_month', $property->expected_rent_sq_ft_month ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="rent_range_band_shown_live"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('rent_range_band_shown_live', $property->rent_range_band_shown_live ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                            ...
                            <div>
                                ...
                                <input type="text" name="expected_sale_price_sq_ft"
                                    value="{{ old('expected_sale_price_sq_ft', $property->expected_sale_price_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="sale_price_band_shown_live"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('sale_price_band_shown_live', $property->sale_price_band_shown_live ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                            ...
                            <div>
                                ...
                                <input type="text" name="cam_charges_sq_ft_month"
                                    value="{{ old('cam_charges_sq_ft_month', $property->cam_charges_sq_ft_month ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="fit_out_rent_free_period_months"
                                    value="{{ old('fit_out_rent_free_period_months', $property->fit_out_rent_free_period_months ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="rental_income_band_shown_live"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('rental_income_band_shown_live', $property->rental_income_band_shown_live ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('rental_income_band_shown_live', $property->rental_income_band_shown_live ?? '') === 'No' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="text" name="rental_yield_roi_p_a"
                                    value="{{ old('rental_yield_roi_p_a', $property->rental_yield_roi_p_a ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="lease_tenure_years"
                                    value="{{ old('lease_tenure_years', $property->lease_tenure_years ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="lock_in_remaining_months"
                                    value="{{ old('lock_in_remaining_months', $property->lock_in_remaining_months ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="cam_outgoings_borne_by"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Tenant" {{ old('cam_outgoings_borne_by', $property->cam_outgoings_borne_by ?? '') === 'Tenant' ? 'selected' : '' }}>Tenant
                                    </option>
                                    <option value="Owner" {{ old('cam_outgoings_borne_by', $property->cam_outgoings_borne_by ?? '') === 'Owner' ? 'selected' : '' }}>Owner</option>
                                    <option value="Shared" {{ old('cam_outgoings_borne_by', $property->cam_outgoings_borne_by ?? '') === 'Shared' ? 'selected' : '' }}>Shared
                                    </option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="wizard-step-content space-y-6" style="display:none">
                    ...
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Interior / common-area photos
                                    <span class="text-red-500">*</span></label>
                                <input required type="text" name="interior_common_area_photos"
                                    value="{{ old('interior_common_area_photos', $property->interior_common_area_photos ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <textarea required name="field_officer_submitter_remarks" rows="2"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">{{ old('field_officer_submitter_remarks', $property->field_officer_submitter_remarks ?? '') }}</textarea>
                            </div>
                            <div class="md:col-span-3">
                                ...
                                <textarea name="property_description_public" rows="2"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">{{ old('property_description_public', $property->property_description_public ?? '') }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Field Officer Name <span
                                        class="text-red-500">*</span></label>
                                <input required type="text" name="field_officer_name"
                                    value="{{ old('field_officer_name', $property->field_officer_name ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Field Verified </label>
                                <input type="text" name="field_verified"
                                    value="{{ old('field_verified', $property->field_verified ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="date" name="inspection_submission_date"
                                    value="{{ old('inspection_submission_date', isset($property->inspection_submission_date) ? $property->inspection_submission_date->format('Y-m-d') : '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
