                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="security_deposit_months"
                                    ...
                                    <option value="6" {{ old('security_deposit_months', $property->security_deposit_months ?? '') === '6' ? 'selected' : '' }}>6</option>
                                    <option value="12 months" {{ old('security_deposit_months', $property->security_deposit_months ?? '') === '12 months' ? 'selected' : '' }}>12 months</option>
