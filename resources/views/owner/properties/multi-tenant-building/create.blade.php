...
<div class="max-w-5xl mx-auto space-y-6" x-data="stepWizard()">
    <div class="flex items-center justify-between mb-2">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Complete section-by-section submission form for Multi-Tenant Commercial Building</p>
        </div>
    ...
    <form method="POST" action="{{ isset($property) ? route('owner.properties.multi-tenant-building.update', $property) : route('owner.properties.multi-tenant-building.store') }}" enctype="multipart/form-data">
        @csrf
        @if(isset($property))
            @method('PUT')
        @endif

        <x-property-wizard-shell :steps="$steps" :title="'Multi-Tenant Commercial Building Submission Form'" :propertyType="'multi_tenant_building'">
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Leasable Area (sq ft) <span class="text-red-500">*</span></label>
                            <input required  type="number" step="any" name="total_leasable_area_sq_ft" value="{{ old('total_leasable_area_sq_ft', $property->total_leasable_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Built-up Area (sq ft) </label>
                            <input type="number" step="any" name="total_built_up_area_sq_ft" value="{{ old('total_built_up_area_sq_ft', $property->total_built_up_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Plot Area (sq ft) </label>
                            <input type="number" step="any" name="plot_area_sq_ft" value="{{ old('plot_area_sq_ft', $property->plot_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Number of Floors <span class="text-red-500">*</span></label>
                            <input required  type="number" step="any" name="number_of_floors" value="{{ old('number_of_floors', $property->number_of_floors ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Typical Floor Plate (sq ft) </label>
                            <input type="number" step="any" name="typical_floor_plate_sq_ft" value="{{ old('typical_floor_plate_sq_ft', $property->typical_floor_plate_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Currently Occupied (%) </label>
                            <input type="number" step="any" name="currently_occupied" value="{{ old('currently_occupied', $property->currently_occupied ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Existing Tenants / Anchor </label>
                            <input type="text" name="existing_tenants_anchor" value="{{ old('existing_tenants_anchor', $property->existing_tenants_anchor ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Car Parking </label>
                            <input type="number" step="any" name="total_car_parking" value="{{ old('total_car_parking', $property->total_car_parking ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Lifts (Passenger / Service count) </label>
                            <input type="text" name="lifts_passenger_service_count" value="{{ old('lifts_passenger_service_count', $property->lifts_passenger_service_count ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="dg_set_capacity" value="{{ old('dg_set_capacity', $property->dg_set_capacity ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Water Supply / Tank Capacity </label>
                            <input type="text" name="water_supply_tank_capacity" value="{{ old('water_supply_tank_capacity', $property->water_supply_tank_capacity ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">STP Plant </label>
                            <select name="stp_plant" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Building Management System </label>
                            <select name="building_management_system" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Yes" {{ old('building_management_system', $property->building_management_system ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('building_management_system', $property->building_management_system ?? '') === 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Security / Access Control </label>
                            <select name="security_access_control" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="24x7" {{ old('security_access_control', $property->security_access_control ?? '') === '24x7' ? 'selected' : '' }}>24x7</option>
                                <option value="Card" {{ old('security_access_control', $property->security_access_control ?? '') === 'Card' ? 'selected' : '' }}>Card</option>
                                <option value="None" {{ old('security_access_control', $property->security_access_control ?? '') === 'None' ? 'selected' : '' }}>None</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Green / IGBC / LEED Certified </label>
                            <select name="green_igbc_leed_certified" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Yes" {{ old('green_igbc_leed_certified', $property->green_igbc_leed_certified ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Interior / common-area photos <span class="text-red-500">*</span></label>
                            <input required  type="text" name="interior_common_area_photos" value="{{ old('interior_common_area_photos', $property->interior_common_area_photos ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
