...
<div class="max-w-5xl mx-auto space-y-6" x-data="stepWizard()">
    <div class="flex items-center justify-between mb-2">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Complete section-by-section submission form for Retail Shop / Showroom</p>
        </div>
    ...
    <form method="POST" action="{{ isset($property) ? route('owner.properties.retail-shop-showroom.update', $property) : route('owner.properties.retail-shop-showroom.store') }}" enctype="multipart/form-data">
        @csrf
        @if(isset($property))
            @method('PUT')
        @endif

        <x-property-wizard-shell :steps="$steps" :title="'Retail Shop / Showroom Submission Form'" :propertyType="'retail_shop_showroom'">
            ...
            <div class="wizard-step-content space-y-6" style="display:block">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Commercial Shop · Showroom · Space in Retail Mall · SCO · 99acres-aligned </label>
                            <input type="text" name="commercial_shop_showroom_space_in_retail_mall_sco_99acres_al" value="{{ old('commercial_shop_showroom_space_in_retail_mall_sco_99acres_al', $property->commercial_shop_showroom_space_in_retail_mall_sco_99acres_al ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Built-up / Chargeable Area (sq ft) </label>
                            <input type="number" step="any" name="built_up_chargeable_area_sq_ft" value="{{ old('built_up_chargeable_area_sq_ft', $property->built_up_chargeable_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Frontage Width (ft) <span class="text-red-500">*</span></label>
                            <input required  type="number" step="any" name="frontage_width_ft" value="{{ old('frontage_width_ft', $property->frontage_width_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Frontage Height / Signage (ft) </label>
                            <input type="number" step="any" name="frontage_height_signage_ft" value="{{ old('frontage_height_signage_ft', $property->frontage_height_signage_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Floor <span class="text-red-500">*</span></label>
                            <select required  name="floor" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="ceiling_height_ft" value="{{ old('ceiling_height_ft', $property->ceiling_height_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Mezzanine Available </label>
                            <select name="mezzanine_available" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="frontage_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="footfall_location_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="High-street" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'High-street' ? 'selected' : '' }}>High-street</option>
                                <option value="Mall" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'Mall' ? 'selected' : '' }}>Mall</option>
                                <option value="Market" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'Market' ? 'selected' : '' }}>Market</option>
                                <option value="Standalone" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'Standalone' ? 'selected' : '' }}>Standalone</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Suitable For (activity) </label>
                            <input type="text" name="suitable_for_activity" value="{{ old('suitable_for_activity', $property->suitable_for_activity ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Washroom </label>
                            <select name="washroom" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select name="parking_for_customers" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Power Load Sanctioned (KW) </label>
                            <input type="number" step="any" name="power_load_sanctioned_kw" value="{{ old('power_load_sanctioned_kw', $property->power_load_sanctioned_kw ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="water_connection" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Kitchen / Exhaust Provision (F&B) </label>
                            <select name="kitchen_exhaust_provision_f_b" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Yes" {{ old('kitchen_exhaust_provision_f_b', $property->kitchen_exhaust_provision_f_b ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('kitchen_exhaust_provision_f_b', $property->kitchen_exhaust_provision_f_b ?? '') === 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="escalator_lift_access" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Shop interior + frontage (inside view) <span class="text-red-500">*</span></label>
                            <input required  type="text" name="shop_interior_frontage_inside_view" value="{{ old('shop_interior_frontage_inside_view', $property->shop_interior_frontage_inside_view ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
