                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="commercial_shop_showroom_space_in_retail_mall_sco_99acres_al"
                                    value="{{ old('commercial_shop_showroom_space_in_retail_mall_sco_99acres_al', $property->commercial_shop_showroom_space_in_retail_mall_sco_99acres_al ?? '') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="property_type"
                                    ...
                                    <option value="Space in Retail Mall" {{ old('property_type', $property->property_type ?? '') === 'Space in Retail Mall' ? 'selected' : '' }}>Space in Retail Mall</option>
                                    <option value="High-Street" {{ old('property_type', $property->property_type ?? '') === 'High-Street' ? 'selected' : '' }}>High-Street</option>
                                    <option value="SCO" {{ old('property_type', $property->property_type ?? '') === 'SCO' ? 'selected' : '' }}>SCO</option>
                                    <option value="Food Court" {{ old('property_type', $property->property_type ?? '') === 'Food Court' ? 'selected' : '' }}>Food Court</option>
                            ...
                            <div>
                                ...
                                <input required type="number" step="any" name="carpet_area_sq_ft"
                                    value="{{ old('carpet_area_sq_ft', $property->carpet_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="built_up_chargeable_area_sq_ft"
                                    value="{{ old('built_up_chargeable_area_sq_ft', $property->built_up_chargeable_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="number" step="any" name="frontage_width_ft"
                                    value="{{ old('frontage_width_ft', $property->frontage_width_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="number" step="any" name="frontage_height_signage_ft"
                                    value="{{ old('frontage_height_signage_ft', $property->frontage_height_signage_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select required name="floor"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Ground" {{ old('floor', $property->floor ?? '') === 'Ground' ? 'selected' : '' }}>Ground</option>
                                    <option value="Upper" {{ old('floor', $property->floor ?? '') === 'Upper' ? 'selected' : '' }}>Upper</option>
                                    <option value="Basement" {{ old('floor', $property->floor ?? '') === 'Basement' ? 'selected' : '' }}>Basement</option>
                                    <option value="Mezzanine" {{ old('floor', $property->floor ?? '') === 'Mezzanine' ? 'selected' : '' }}>Mezzanine</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Ceiling Height (ft) </label>
                                <input type="text" name="ceiling_height_ft"
                                    value="{{ old('ceiling_height_ft', $property->ceiling_height_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="mezzanine_available"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('mezzanine_available', $property->mezzanine_available ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('mezzanine_available', $property->mezzanine_available ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="frontage_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Main road" {{ old('frontage_type', $property->frontage_type ?? '') === 'Main road' ? 'selected' : '' }}>Main road</option>
                                    <option value="Internal" {{ old('frontage_type', $property->frontage_type ?? '') === 'Internal' ? 'selected' : '' }}>Internal</option>
                                    <option value="Corner" {{ old('frontage_type', $property->frontage_type ?? '') === 'Corner' ? 'selected' : '' }}>Corner</option>
                                    <option value="Mall atrium" {{ old('frontage_type', $property->frontage_type ?? '') === 'Mall atrium' ? 'selected' : '' }}>Mall atrium</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="footfall_location_type"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="High-street" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'High-street' ? 'selected' : '' }}>
                                        High-street</option>
                                    <option value="Mall" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'Mall' ? 'selected' : '' }}>Mall</option>
                                    <option value="Market" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'Market' ? 'selected' : '' }}>Market
                                    </option>
                                    <option value="Standalone" {{ old('footfall_location_type', $property->footfall_location_type ?? '') === 'Standalone' ? 'selected' : '' }}>
                                        Standalone</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="text" name="suitable_for_activity"
                                    value="{{ old('suitable_for_activity', $property->suitable_for_activity ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="washroom"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Private" {{ old('washroom', $property->washroom ?? '') === 'Private' ? 'selected' : '' }}>Private</option>
                                    <option value="Common" {{ old('washroom', $property->washroom ?? '') === 'Common' ? 'selected' : '' }}>Common</option>
                                    <option value="None" {{ old('washroom', $property->washroom ?? '') === 'None' ? 'selected' : '' }}>None</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="parking_for_customers"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Ample" {{ old('parking_for_customers', $property->parking_for_customers ?? '') === 'Ample' ? 'selected' : '' }}>Ample</option>
                                    <option value="Limited" {{ old('parking_for_customers', $property->parking_for_customers ?? '') === 'Limited' ? 'selected' : '' }}>Limited</option>
                                    <option value="None" {{ old('parking_for_customers', $property->parking_for_customers ?? '') === 'None' ? 'selected' : '' }}>None</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="furnishing_fit_out"
                                    ...
                                    <option value="Fitted" {{ old('furnishing_fit_out', $property->furnishing_fit_out ?? '') === 'Fitted' ? 'selected' : '' }}>Fitted</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="power_load_sanctioned_kw"
                                    value="{{ old('power_load_sanctioned_kw', $property->power_load_sanctioned_kw ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <select name="power_backup"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('power_backup', $property->power_backup ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('power_backup', $property->power_backup ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                    <option value="Provision" {{ old('power_backup', $property->power_backup ?? '') === 'Provision' ? 'selected' : '' }}>Provision</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="water_connection"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('water_connection', $property->water_connection ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('water_connection', $property->water_connection ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="kitchen_exhaust_provision_f_b"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('kitchen_exhaust_provision_f_b', $property->kitchen_exhaust_provision_f_b ?? '') === 'Yes' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="No" {{ old('kitchen_exhaust_provision_f_b', $property->kitchen_exhaust_provision_f_b ?? '') === 'No' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="air_conditioning"
                                    ...
                                    <option value="Split" {{ old('air_conditioning', $property->air_conditioning ?? '') === 'Split' ? 'selected' : '' }}>Split</option>
                            ...
                            <div>
                                ...
                                <select name="escalator_lift_access"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Yes" {{ old('escalator_lift_access', $property->escalator_lift_access ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('escalator_lift_access', $property->escalator_lift_access ?? '') === 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="wizard-step-content space-y-6" style="display:none">
                    ...
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Shop interior + frontage (inside
                                    view) <span class="text-red-500">*</span></label>
                                <input required type="text" name="shop_interior_frontage_inside_view"
                                    value="{{ old('shop_interior_frontage_inside_view', $property->shop_interior_frontage_inside_view ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
