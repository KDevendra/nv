                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="star_positioning" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="number_of_keys_rooms" value="{{ old('number_of_keys_rooms', $property->number_of_keys_rooms ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="operational_status" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
            ...
            <div class="wizard-step-content space-y-6" style="display:none">
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Interior / room / facility photos <span class="text-red-500">*</span></label>
                            <input type="text" name="interior_room_facility_photos" value="{{ old('interior_room_facility_photos', $property->interior_room_facility_photos ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
