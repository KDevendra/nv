...
@section('content')
    @php
        ...
        // config('property_entry_sections.hotel_resort_guesthouse_banquet').
        ...
        $steps = [
            ...
            ['key' => 'C', 'title' => 'Asset Configuration'],
            ['key' => 'D', 'title' => 'Legal & Compliance'],
            ['key' => 'E', 'title' => 'Licences & Infrastructure'],
    ...
    <div class="max-w-5xl mx-auto space-y-6" x-data="stepWizard()">
        <div class="flex items-center justify-between mb-2">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Complete section-by-section submission form for Hospitality — Hotel /
                    Resort / Guest House</p>
            </div>
        ...
        <form method="POST"
            action="{{ isset($property) ? route('owner.properties.hotel-resort-guesthouse-banquet.update', $property) : route('owner.properties.hotel-resort-guesthouse-banquet.store') }}"
            ...
            <x-property-wizard-shell :steps="$steps" :title="'Hospitality — Hotel / Resort / Guest House Submission Form'"
                :propertyType="'hotel_resort_guesthouse_banquet'">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="property_type"
                                    ...
                                    <option value="Guest House" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Guest House' ? 'selected' : '' }}>
                                        Guest House</option>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Star / Positioning <span
                                        class="text-red-500">*</span></label>
                                <select required name="star_positioning"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Budget" {{ old('star_positioning', $property?->fieldValue('star_positioning') ?? '') === 'Budget' ? 'selected' : '' }}>
                                        Budget</option>
                                    <option value="3-Star" {{ old('star_positioning', $property?->fieldValue('star_positioning') ?? '') === '3-Star' ? 'selected' : '' }}>
                                        3-Star</option>
                                    <option value="4-Star" {{ old('star_positioning', $property?->fieldValue('star_positioning') ?? '') === '4-Star' ? 'selected' : '' }}>
                                        4-Star</option>
                                    <option value="5-Star" {{ old('star_positioning', $property?->fieldValue('star_positioning') ?? '') === '5-Star' ? 'selected' : '' }}>
                                        5-Star</option>
                                    <option value="Unbranded" {{ old('star_positioning', $property?->fieldValue('star_positioning') ?? '') === 'Unbranded' ? 'selected' : '' }}>Unbranded</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Total Land / Plot Area (sq ft)
                                </label>
                                <input type="number" step="any" name="total_land_plot_area_sq_ft"
                                    value="{{ old('total_land_plot_area_sq_ft', $property?->fieldValue('total_land_plot_area_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Total Built-up Area (sq ft)
                                    <span class="text-red-500">*</span></label>
                                <input required type="number" step="any" name="total_built_up_area_sq_ft"
                                    value="{{ old('total_built_up_area_sq_ft', $property?->fieldValue('total_built_up_area_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Number of Keys / Rooms <span
                                        class="text-red-500">*</span></label>
                                <input required type="number" step="any" name="number_of_keys_rooms"
                                    value="{{ old('number_of_keys_rooms', $property?->fieldValue('number_of_keys_rooms') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Number of Floors </label>
                                <input type="number" step="any" name="number_of_floors"
                                    value="{{ old('number_of_floors', $property?->fieldValue('number_of_floors') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Banquet / Event Space (sq ft)
                                </label>
                                <input type="number" step="any" name="banquet_event_space_sq_ft"
                                    value="{{ old('banquet_event_space_sq_ft', $property?->fieldValue('banquet_event_space_sq_ft') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Banquet Guest Capacity (pax)
                                </label>
                                <input type="number" step="any" name="banquet_guest_capacity_pax"
                                    value="{{ old('banquet_guest_capacity_pax', $property?->fieldValue('banquet_guest_capacity_pax') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Restaurant / F&B Outlets
                                </label>
                                <input type="number" step="any" name="restaurant_f_b_outlets"
                                    value="{{ old('restaurant_f_b_outlets', $property?->fieldValue('restaurant_f_b_outlets') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Parking Capacity </label>
                                <input type="number" step="any" name="parking_capacity"
                                    value="{{ old('parking_capacity', $property?->fieldValue('parking_capacity') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Operational Status <span
                                        class="text-red-500">*</span></label>
                                <select required name="operational_status"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    ...
                                    <option value="Closed" {{ old('operational_status', $property?->fieldValue('operational_status') ?? '') === 'Closed' ? 'selected' : '' }}>
                                        Closed</option>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Existing Brand / Operator
                                </label>
                                <input type="text" name="existing_brand_operator"
                                    value="{{ old('existing_brand_operator', $property?->fieldValue('existing_brand_operator') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Furnishing / FF&E Status
                                </label>
                                <select name="furnishing_ff_e_status"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select required name="fire_noc_status"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Obtained" {{ old('fire_noc_status', $property?->fieldValue('fire_noc_status') ?? '') === 'Obtained' ? 'selected' : '' }}>
                                        Obtained</option>
                ...
                <div class="wizard-step-content space-y-6" style="display:none">
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Hotel / Hospitality Licence
                                </label>
                                <select name="hotel_hospitality_licence"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="water_source_stp"
                                    value="{{ old('water_source_stp', $property?->fieldValue('water_source_stp') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Lifts </label>
                                <input type="number" step="any" name="lifts"
                                    value="{{ old('lifts', $property?->fieldValue('lifts') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Kitchen Infrastructure </label>
                                <select name="kitchen_infrastructure"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                ...
                <div class="wizard-step-content space-y-6" style="display:none">
                    ...
                    <div class="border-t pt-4 first:border-t-0 first:pt-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Current Revenue / ARR /
                                    Occupancy % </label>
                                <input type="text" name="current_revenue_arr_occupancy"
                                    value="{{ old('current_revenue_arr_occupancy', $property?->fieldValue('current_revenue_arr_occupancy') ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
