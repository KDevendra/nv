                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="bonded_export_oriented_unit_distinct_compliance_loa_nfe_cust" value="{{ old('bonded_export_oriented_unit_distinct_compliance_loa_nfe_cust', $property?->fieldValue('bonded_export_oriented_unit_distinct_compliance_loa_nfe_cust') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="property_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="STPI Unit" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'STPI Unit' ? 'selected' : '' }}>STPI Unit</option>
                                <option value="FTWZ Unit" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'FTWZ Unit' ? 'selected' : '' }}>FTWZ Unit</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Zone / Park Name <span class="text-red-500">*</span></label>
                            <input required  type="text" name="zone_park_name" value="{{ old('zone_park_name', $property?->fieldValue('zone_park_name') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Space Type <span class="text-red-500">*</span></label>
                            <select required  name="space_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <input required  type="number" step="any" name="carpet_usable_area_sq_ft" value="{{ old('carpet_usable_area_sq_ft', $property?->fieldValue('carpet_usable_area_sq_ft') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Built-up Area (sq ft) </label>
                            <input type="number" step="any" name="built_up_area_sq_ft" value="{{ old('built_up_area_sq_ft', $property?->fieldValue('built_up_area_sq_ft') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="sector_focus" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="Electronics" {{ old('sector_focus', $property?->fieldValue('sector_focus') ?? '') === 'Electronics' ? 'selected' : '' }}>Electronics</option>
                                ...
                                <option value="Engineering" {{ old('sector_focus', $property?->fieldValue('sector_focus') ?? '') === 'Engineering' ? 'selected' : '' }}>Engineering</option>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="zone_notification_status" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select required  name="processing_non_processing_area" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select required  name="developer_consent_for_sub_lease" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                        ...
                        <div>
                            ...
                            <select required  name="title_lease_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="power_sanctioned_kva" value="{{ old('power_sanctioned_kva', $property?->fieldValue('power_sanctioned_kva') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="redundant_power_dg" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="N+1" {{ old('redundant_power_dg', $property?->fieldValue('redundant_power_dg') ?? '') === 'N+1' ? 'selected' : '' }}>N+1</option>
                                <option value="N" {{ old('redundant_power_dg', $property?->fieldValue('redundant_power_dg') ?? '') === 'N' ? 'selected' : '' }}>N</option>
                                <option value="None" {{ old('redundant_power_dg', $property?->fieldValue('redundant_power_dg') ?? '') === 'None' ? 'selected' : '' }}>None</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="air_conditioning" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="VRV" {{ old('air_conditioning', $property?->fieldValue('air_conditioning') ?? '') === 'VRV' ? 'selected' : '' }}>VRV</option>
                        ...
                        <div>
                            ...
                            <select name="fire_safety_system" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="Basic" {{ old('fire_safety_system', $property?->fieldValue('fire_safety_system') ?? '') === 'Basic' ? 'selected' : '' }}>Basic</option>
