                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input required  type="number" step="any" name="plot_area_sq_ft_acre" value="{{ old('plot_area_sq_ft_acre', $property->plot_area_sq_ft_acre ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Covered / Built-up Area (sq ft) <span class="text-red-500">*</span></label>
                            <input required  type="number" step="any" name="covered_built_up_area_sq_ft" value="{{ old('covered_built_up_area_sq_ft', $property->covered_built_up_area_sq_ft ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input required  type="text" name="sanctioned_power_load_kw_kva" value="{{ old('sanctioned_power_load_kw_kva', $property->sanctioned_power_load_kw_kva ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
