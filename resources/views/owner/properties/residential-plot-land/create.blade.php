                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="property_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="Gated Plot" {{ old('property_type', $property?->fieldValue('property_type') ?? '') === 'Gated Plot' ? 'selected' : '' }}>Gated Plot</option>
                        ...
                        <div>
                            ...
                            <input required  type="number" step="any" name="plot_area" value="{{ old('plot_area', $property?->fieldValue('plot_area') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="gated_community_plot" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Yes" {{ old('gated_community_plot', $property?->fieldValue('gated_community_plot') ?? '') === 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('gated_community_plot', $property?->fieldValue('gated_community_plot') ?? '') === 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="construction_permitted_floors" value="{{ old('construction_permitted_floors', $property?->fieldValue('construction_permitted_floors') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">FAR / FSI Permitted </label>
                            <input type="text" name="far_fsi_permitted" value="{{ old('far_fsi_permitted', $property?->fieldValue('far_fsi_permitted') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="land_use_zoning" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="Mixed" {{ old('land_use_zoning', $property?->fieldValue('land_use_zoning') ?? '') === 'Mixed' ? 'selected' : '' }}>Mixed</option>
                        ...
                        <div>
                            ...
                            <select required  name="litigation_dispute" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="None" {{ old('litigation_dispute', $property?->fieldValue('litigation_dispute') ?? '') === 'None' ? 'selected' : '' }}>None</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select required  name="road_access_to_plot" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                ...
                                <option value="None" {{ old('road_access_to_plot', $property?->fieldValue('road_access_to_plot') ?? '') === 'None' ? 'selected' : '' }}>None</option>
                            </select>
                        </div>
                        <div>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="price_per_sq_ft_sq_yd" value="{{ old('price_per_sq_ft_sq_yd', $property?->fieldValue('price_per_sq_ft_sq_yd') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
