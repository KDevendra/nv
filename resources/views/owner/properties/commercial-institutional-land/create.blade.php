                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="plot_dimensions_ft_ft" value="{{ old('plot_dimensions_ft_ft', $property?->fieldValue('plot_dimensions_ft_ft') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Plot Frontage (ft) </label>
                            <input type="number" step="any" name="plot_frontage_ft" value="{{ old('plot_frontage_ft', $property?->fieldValue('plot_frontage_ft') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select required  name="permitted_land_use" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                ...
                                <option value="Mixed" {{ old('permitted_land_use', $property?->fieldValue('permitted_land_use') ?? '') === 'Mixed' ? 'selected' : '' }}>Mixed</option>
                        ...
                        <div>
                            ...
                            <input required  type="text" name="far_fsi_permitted" value="{{ old('far_fsi_permitted', $property?->fieldValue('far_fsi_permitted') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Ground Coverage Allowed (%) </label>
                            <input type="number" step="any" name="ground_coverage_allowed" value="{{ old('ground_coverage_allowed', $property?->fieldValue('ground_coverage_allowed') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Max Height / Floors Permitted </label>
                            <input type="text" name="max_height_floors_permitted" value="{{ old('max_height_floors_permitted', $property?->fieldValue('max_height_floors_permitted') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="khasra_survey_number" value="{{ old('khasra_survey_number', $property?->fieldValue('khasra_survey_number') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input required  type="number" step="any" name="road_frontage_approach_width_ft" value="{{ old('road_frontage_approach_width_ft', $property?->fieldValue('road_frontage_approach_width_ft') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Distance from Main Road / Highway (km) </label>
                            <input type="text" name="distance_from_main_road_highway_km" value="{{ old('distance_from_main_road_highway_km', $property?->fieldValue('distance_from_main_road_highway_km') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="sewage_drainage" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                <option value="">— Select —</option>
                                <option value="Available" {{ old('sewage_drainage', $property?->fieldValue('sewage_drainage') ?? '') === 'Available' ? 'selected' : '' }}>Available</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="surrounding_development" value="{{ old('surrounding_development', $property?->fieldValue('surrounding_development') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="border-t pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="expected_sale_price_sq_ft_or_acre" value="{{ old('expected_sale_price_sq_ft_or_acre', $property?->fieldValue('expected_sale_price_sq_ft_or_acre') ?? '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        </div>
                        <div>
