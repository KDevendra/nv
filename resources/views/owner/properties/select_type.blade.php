    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <a href="{{ route('owner.properties.create') }}"
                class="group bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:shadow-md hover:border-amber-500 transition-all flex flex-col justify-between relative overflow-hidden">
                <div class="absolute top-0 right-0 bg-amber-50 text-amber-700 border-b border-l border-amber-200 text-[10px] font-mono font-bold px-2 py-0.5 rounded-bl-lg">
                    ZI-WH-
                </div>
                <div>
                    <div class="w-10 h-10 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center mb-3 group-hover:bg-amber-600 group-hover:text-white transition-colors">
                        {!! $warehouseType['icon_svg'] ?? '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V10l-6-4-6 4v11m12 0H5m14 0h2M5 21H3m2 0v-6a2 2 0 012-2h2a2 2 0 012 2v6m0 0h2"/></svg>' !!}
                    </div>
                    <h4 class="text-base font-bold text-zendo-navy group-hover:text-amber-700 transition-colors">
                ...
                <div class="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-xs font-semibold text-amber-700">
                ...
                <a href="{{ route('owner.properties.create-type', ['type' => $type['slug']]) }}"
                    ...
                    <div>
                        <div class="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center mb-3 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                            {!! $type['icon_svg'] ?? '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>' !!}
                        </div>
                ...
                <a href="{{ route('owner.properties.create-type', ['type' => $type['slug']]) }}"
                    ...
                    <div>
                        <div class="w-9 h-9 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-3 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            {!! $type['icon_svg'] ?? '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m3 0v-4a1 1 0 011-1h2a1 1 0 011 1v4m-4 0h4"/></svg>' !!}
                        </div>
