                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input required type="number" step="any" name="plot_area_sq_ft_sq_yd"
                                    value="{{ old('plot_area_sq_ft_sq_yd', $property->plot_area_sq_ft_sq_yd ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input required type="number" step="any" name="constructed_built_up_area_sq_ft"
                                    value="{{ old('constructed_built_up_area_sq_ft', $property->constructed_built_up_area_sq_ft ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input required type="number" step="any" name="no_of_floors"
                                    value="{{ old('no_of_floors', $property->no_of_floors ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="car_parking_capacity"
                                    value="{{ old('car_parking_capacity', $property->car_parking_capacity ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="extension_vertical_expansion_possible"
                                    ...
                                    <option value="No" {{ old('extension_vertical_expansion_possible', $property->extension_vertical_expansion_possible ?? '') === 'No' ? 'selected' : '' }}>
                                        No</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="sanctioned_power_load_kw"
                                    value="{{ old('sanctioned_power_load_kw', $property->sanctioned_power_load_kw ?? '') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="security_arrangement"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
                                    <option value="">— Select —</option>
                                    <option value="Gated colony" {{ old('security_arrangement', $property->security_arrangement ?? '') === 'Gated colony' ? 'selected' : '' }}>Gated
                                        colony</option>
                                    <option value="Standalone" {{ old('security_arrangement', $property->security_arrangement ?? '') === 'Standalone' ? 'selected' : '' }}>
                                        Standalone</option>
