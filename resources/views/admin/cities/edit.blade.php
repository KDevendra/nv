...
<div class="bg-gray-100 p-6 rounded-lg mb-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-heading text-zendo-navy font-semibold">Edit City</h1>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Enter city description">{{ old('description', $city->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="property_count" 
                           id="property_count" 
                           value="{{ old('property_count', $city->property_count) }}"
                           min="0"
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $city->image ? 'Replace Image' : 'City Image' }}
                    </label>
