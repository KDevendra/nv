@extends('layouts.app')
@section('title', 'CM to Inches - ZendoIndia')
@section('content')
<style>
...
<section class="about-banner-section">
    ...
    <div class="about-banner-container">
        <h1 class="about-banner-heading">CM to Inches</h1>
      ...
      <div class="apw-calcHubV2__main">
        ...
        <div class="apw-calcHubV2__head">
          ...
          <p class="apw-calcHubV2__sub">
            Use this CM to Inches calculator to convert instantly and visualize the result with a graph.
          </p>
        </div>
        ...
        <div class="apw-calcCardV2">
          <div class="apw-calcCardV2__top">
            <h3 class="apw-calcCardV2__title">CM to Inches Converter</h3>
          ...
          <div class="apw-calcCardV2__grid">
            ...
            <form class="apw-calcFormV2" id="apwV2-cmForm" novalidate>
              ...
              <div class="apw-fieldV2">
                ...
                <small class="apw-helpV2">Example: 25.4 cm</small>
              </div>
            ...
            <!-- Results -->
            <aside class="apw-calcResultsV2" aria-label="CM to inches results">
              ...
              <div class="apw-graphV2" aria-label="Graph representation">
                <div class="apw-graphV2__head">
                  ...
                  <span class="apw-graphV2__meta" id="apwV2-cmGraphMeta">CM vs Inches</span>
                </div>
      ...
      <aside class="apw-calcHubV2__side" aria-label="Other calculators">
        <div class="apw-sideCardV2">
          ...
          <nav class="apw-sideNavV2">
            ...
            <a class="apw-sideNavV2__item is-active" href="{{ route('calculators.cm-to-inches') }}" aria-current="page">
              <span class="apw-sideNavV2__icon" aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    (function () {
      ...
      function calculate() {
        ...
        if (msg) {
          ...
          ui.out.graphMeta.textContent = "CM vs Inches";
        ...
        const maxVal = Math.max(cm, inch, 1e-6);
        ...
        ui.out.graphMeta.textContent = `CM (${fmt(cm, 2)}) vs Inches (${fmt(inch, 2)})`;
      }
