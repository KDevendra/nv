@extends('layouts.app')
@section('title', 'Feet to Inches - ZendoIndia')
@section('content')
<style>
...
<section class="about-banner-section">
    ...
    <div class="about-banner-container">
        <h1 class="about-banner-heading">Feet to Inches</h1>
      ...
      <div class="apw-calcHubV2__main">
        ...
        <div class="apw-calcHubV2__head">
          ...
          <p class="apw-calcHubV2__sub">
            Use this Feet to Inches calculator to convert instantly and visualize the result with a graph.
          </p>
        </div>
        ...
        <div class="apw-calcCardV2">
          <div class="apw-calcCardV2__top">
            <h3 class="apw-calcCardV2__title">Feet to Inches Converter</h3>
          ...
          <div class="apw-calcCardV2__grid">
            ...
            <!-- Results -->
            <aside class="apw-calcResultsV2" aria-label="Feet to inches results">

              <div class="apw-resultHeroV2">
                <span class="apw-resultHeroV2__label">Converted Inches</span>
                <strong class="apw-resultHeroV2__value" id="apwV2-inchHero">0 in</strong>
              ...
              <div class="apw-graphV2" aria-label="Graph representation">
                <div class="apw-graphV2__head">
                  ...
                  <span class="apw-graphV2__meta" id="apwV2-ftGraphMeta">Feet vs Inches</span>
                </div>
                ...
                <div class="apw-barsV2">
                  ...
                  <div class="apw-barV2">
                    <div class="apw-barV2__top">
                      <span class="apw-barV2__label">Inches</span>
                      <strong class="apw-barV2__val" id="apwV2-barInVal">0</strong>
                    </div>
                    <div class="apw-barV2__track">
                      <div class="apw-barV2__fill" id="apwV2-barIn"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <p class="apw-disclaimerV2">
                * 1 ft = 12 in (standard conversion).
              </p>
      ...
      <aside class="apw-calcHubV2__side" aria-label="Other calculators">
        <div class="apw-sideCardV2">
          ...
          <nav class="apw-sideNavV2">
            ...
            <a class="apw-sideNavV2__item is-active" href="{{ route('calculators.ft-to-inches') }}" aria-current="page">
              <span class="apw-sideNavV2__icon" aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 7h16" stroke="#b39359" stroke-width="2" stroke-linecap="round"/>
  ...
  <script>
    (function () {
      ...
      const ui = {
        ...
        out: {
          inchHero: root.querySelector("#apwV2-inchHero"),
          ...
          barIn: root.querySelector("#apwV2-barIn"),
          barFtVal: root.querySelector("#apwV2-barFtVal"),
          barInVal: root.querySelector("#apwV2-barInVal"),
        }
      };
      ...
      function calculate() {
        ...
        ui.out.inchHero.textContent = `${fmt(inch, 2)} in`;
        ...
        const maxVal = Math.max(ft, inch, 1e-6);
        const ftPct = Math.min(100, (ft / maxVal) * 100);
        const inPct = Math.min(100, (inch / maxVal) * 100);

        ui.out.barFt.style.width = ftPct.toFixed(1) + "%";
        ui.out.barIn.style.width = inPct.toFixed(1) + "%";

        ui.out.barFtVal.textContent = fmt(ft, 2);
        ui.out.barInVal.textContent = fmt(inch, 2);

        ui.out.graphMeta.textContent = `Feet (${fmt(ft, 2)}) vs Inches (${fmt(inch, 2)})`;
      }
