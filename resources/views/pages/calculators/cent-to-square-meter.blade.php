...
<section id="apw-calcHubV2" class="apw-calcHubV2">
      ...
      <div class="apw-calcHubV2__main">
        ...
        <div class="apw-calcCardV2">
          <div class="apw-calcCardV2__top">
            <h3 class="apw-calcCardV2__title">Cent to Square Meter Converter</h3>
          ...
          <div class="apw-calcCardV2__grid">
            ...
            <!-- Right: Results -->
            <aside class="apw-calcResultsV2" aria-label="Cent to square meter results">
              <div class="apw-resultHeroV2">
                <span class="apw-resultHeroV2__label">Converted Area</span>
                <strong class="apw-resultHeroV2__value" id="apwV2-cent-sqmHero">0 m²</strong>
              ...
              <div class="apw-graphV2" aria-label="Graph representation">
                <div class="apw-graphV2__head">
                  ...
                  <span class="apw-graphV2__meta" id="apwV2-cent-graphMeta">Cent vs Sq Meter</span>
                </div>
                ...
                <div class="apw-barsV2">
                  ...
                  <div class="apw-barV2">
                    <div class="apw-barV2__top">
                      <span class="apw-barV2__label">Square Meter</span>
                      <strong class="apw-barV2__val" id="apwV2-cent-barSqmVal">0</strong>
                    </div>
                    <div class="apw-barV2__track">
                      <div class="apw-barV2__fill" id="apwV2-cent-barSqm"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <p class="apw-disclaimerV2">
                * 1 Cent = 40.468564224 Square Meter (m²). Values are approximate.
              </p>
            </aside>
          </div>
        </div>
      ...
      <aside class="apw-calcHubV2__side" aria-label="Other calculators">
        <div class="apw-sideCardV2">
          ...
          <nav class="apw-sideNavV2">
            ...
            <a class="apw-sideNavV2__item is-active" href="{{ route('calculators.cent-to-square-meter') }}" aria-current="page">
              <span class="apw-sideNavV2__icon" aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3 3h18v18H3V3z" stroke="#b39359" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <script>
    (function () {
      ...
      // constants
      const SQM_PER_CENT = 40.468564224; // 1 cent = 1/100 acre; 1 acre = 4046.8564224 m²
      ...
      const ui = {
        ...
        out: {
          sqmHero: root.querySelector("#apwV2-cent-sqmHero"),
          ...
          barSqm: root.querySelector("#apwV2-cent-barSqm"),
          barCentVal: root.querySelector("#apwV2-cent-barCentVal"),
          barSqmVal: root.querySelector("#apwV2-cent-barSqmVal"),
        }
      };
