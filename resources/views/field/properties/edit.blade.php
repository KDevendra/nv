...
<div class="max-w-4xl mx-auto">
    ...
    @if($errors->any())
        ...
        function errorStepper() {
            return {
                ...
                init() { this.currentStep = 0; this.$nextTick(() => this.scrollToSection()); },
                ...
                scrollToSection() {
                    ...
                    for (const h of headings) {
                        if (h.dataset.sectionTitle === title) {
                            ...
                            if (sectionEl && sectionEl._x_dataStack) sectionEl._x_dataStack[0].open = true;
    ...
    <form method="POST" action="{{ route('field.properties.update', $property) }}" enctype="multipart/form-data" x-data="{ isDraft: false }">
        @csrf
        @method('PUT')
